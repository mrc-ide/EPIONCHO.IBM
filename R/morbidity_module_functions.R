...
find_indiv_totest_func <- function(dat, mf.start, mf.end, morb.mat.tmp, age_to_samp_vec_reversible,
...
new_cases_morbidity_func<- function(morb.mat.tmp, temp_mf, SI_probs, RSD_probs, Atrp_probs, Hg_probs, Depigm_probs){

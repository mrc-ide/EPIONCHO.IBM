...
ggsave(
  paste0("images/images_", run_version, "/togo_combined_normalized_mse.pdf"),
  combined_heat_map,
  width=175, height=110.5, units="mm", dpi=600
)
...
makePrefectureBarSensSpecBestFit <- function(original_data, projection_df_list, use_all_age=TRUE, descriptor="", sero_dfs=list(), use_dist_sens_spec=FALSE, sero_val=FALSE, hyps=c("H4i", "H4iii")) {
  ...
  ggsave(paste("images/images_", run_version, "/togo_sens_spec_analysis_bar_", descriptor, ".pdf", sep=""), plot, width=175, height=110.5, units="mm", dpi=300)
}
...
makeAgeGroupGraphsSensSpecBestFit <- function(originalData, projection_df_list, descriptor, facet_value="sens ~ spec", facet_1, facet_2, best_fit_sens_spec) {
  ...
  tmp_projection_data <- combined_df_2 %>% 
    ...
    ggsave(paste("images/images_", run_version, "/togo_sens_spec_analysis_", descriptor, ".pdf", sep=""), p1, width=175, height=110.5, units="mm", dpi=300)
    print(p1)
}

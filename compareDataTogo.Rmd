...
summarizeSimulationDataHelper_2 <- function(df, groupByCols1, groupByCols2, hypNamesLoc, hypothesisNames, groupHyp) {
  hypNamesLoc2 <- hypNamesLoc+2
  hypNamesLoc3 <- hypNamesLoc2+2
  df <- df %>%
  ...
  df <- df %>%
    as.data.frame() %>% pivot_longer(cols=all_of(hypNamesLoc), names_to="Hypothesis", values_to = "ov16_prev")# %>% pivot_longer(cols=all_of(hypNamesLoc2), names_to="Hypothesis_LB", values_to = "ov16_prev_lb")  %>% pivot_longer(cols=all_of(hypNamesLoc3), names_to="Hypothesis_UB", values_to = "ov16_prev_ub")
...
makeBarCharts <- function(groupedDf, simulationDf, prefectureVal, extra="", label=c("a)", "b)")) {
  ...
  simulationDf$all_ages[19:21,] <- list(c(0.6, 0.75, 0.95), rep('Actual Data', 3), rep(allAgeOv16, 3), rep(0, 3))
  simulationDf$all_ages$lb <- c(rep(NA, 18), rep(all_ages_lb, 3))
  simulationDf$all_ages$ub <- c(rep(NA, 18), rep(all_ages_ub, 3))
  
  simulationDf$under10[19:21,] <- list(c(0.6, 0.75, 0.95), rep('Actual Data', 3), rep(under10Ov16, 3), rep(0, 3))
  ...
  allagesplot <- ggplot() + geom_bar(aes(x=factor(vctr.ctrl.eff*100), y=ov16_prev*100, fill=Hypothesis), stat="identity", position="dodge", data=simulationDf$all_ages) + geom_errorbar(aes(x=factor(vctr.ctrl.eff*100), ymin=lb, ymax=ub, group=Hypothesis), color="red", position="dodge", data=simulationDf$all_ages) +
  ...
  under10plot <- ggplot() + geom_bar(aes(x=factor(vctr.ctrl.eff*100), y=ov16_prev*100, fill=Hypothesis), stat="identity", position="dodge", data=simulationDf$under10) +  geom_errorbar(aes(x=factor(vctr.ctrl.eff*100), ymin=lb, ymax=ub, group=Hypothesis), color="red", position="dodge", data=simulationDf$under10) +
  scale_fill_manual(values = color_vals) + ggtitle(paste(label[2], "<10 Seroprevalence in", prefectureVal)) +
    xlab("Vector Control Efficacy (%)") +
    ylab("Ov16 Seroprevalence (%)") +
    theme(
      title = element_text(size=10),
...
#grid.arrange(oti_bar_adjusted$allages + theme(legend.position="none"), oti_bar_adjusted$under10 + theme(legend.position="none"), keran_bar_adjusted$allages + theme(legend.position="none"), keran_bar_adjusted$under10 + theme(legend.position="none"), bassar_bar_adjusted$allages, ncol=2)
...
#grid.arrange(oti_bar_k4$allages + theme(legend.position="none"), oti_bar_k4$under10 + theme(legend.position="none"), keran_bar_k4$allages + theme(legend.position="none"), keran_bar_k4$under10 + theme(legend.position="none"), bassar_bar_k4$allages, ncol=2)
...
#grid.arrange(oti_bar_k4_adjusted$allages + theme(legend.position="none"), oti_bar_k4_adjusted$under10 + theme(legend.position="none"), keran_bar_k4_adjusted$allages + theme(legend.position="none"), keran_bar_k4_adjusted$under10 + theme(legend.position="none"), bassar_bar_k4_adjusted$allages, ncol=2)
...
#grid.arrange(oti_bar_k4_seroreversion$allages + theme(legend.position="none"), oti_bar_k4_seroreversion$under10 + theme(legend.position="none"), keran_bar_k4_seroreversion$allages + theme(legend.position="none"), keran_bar_k4_seroreversion$under10 + theme(legend.position="none"), bassar_bar_k4_seroreversion$allages, ncol=2)
...
#grid.arrange(oti_bar_k4_100_mount$allages + theme(legend.position="none"), oti_bar_k4_100_mount$under10 + theme(legend.position="none"), keran_bar_k4_100_mount$allages + theme(legend.position="none"), keran_bar_k4_100_mount$under10 + theme(legend.position="none"), bassar_bar_k4_100_mount$allages, ncol=2)
...
original_bar_plots_k3_100_mount <- savePlots(oti_bar_k3_100_mount$allages + theme(legend.position="none"), oti_bar_k3_100_mount$under10 + theme(legend.position="none"), keran_bar_k3_100_mount$allages + theme(legend.position="none"), keran_bar_k3_100_mount$under10 + theme(legend.position="none"), bassar_bar_k3_100_mount$allages)
#grid.arrange(oti_bar_k3_100_mount$allages + theme(legend.position="none"), oti_bar_k3_100_mount$under10 + theme(legend.position="none"), keran_bar_k3_100_mount$allages + theme(legend.position="none"), keran_bar_k3_100_mount$under10 + theme(legend.position="none"), bassar_bar_k3_100_mount$allages, nrow=3, ncol=2, heights=c(1, 2))
ggsave("images/togo_prefecture_bar_plots_k3_100_mount.png", original_bar_plots_k3_100_mount, width=7500, height = 6000, units="px", dpi=900)

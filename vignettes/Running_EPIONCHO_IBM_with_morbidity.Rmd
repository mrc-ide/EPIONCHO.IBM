...
When run on laptop machine using Windows, a single run of EPIONCHO-IBM with the activated epilepsy module takes, 
...
remotes::install_github("mrc-ide/EPIONCHO.IBM", ref="additional_updates")

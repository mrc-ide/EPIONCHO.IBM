...
plot(years, output_treat_annual$ov16_seroprevalence_no_seroreversion, type = 'l', xlab = 'time', ylab = 'mean seroprevalence w/o seroreversion')

abline(v = seq(1, 25), col = 'grey', lwd = 0.1)

plot(years, output_treat_annual$ov16_seroprevalence_finite_seroreversion, type = 'l', xlab = 'time', ylab = 'mean seroprevalence w/ finite seroreversion')

...
The output from run_EPIONCHO_IBM is a list with twelve elements.
...
plot(tme, output_equilibrium$ov16_seroprevalence_no_seroreversion, type = 'l', xlab = 'time (years)', ylab = 'seroprevalence w/ no seroreversion', ylim = c(0, 1))

plot(tme, output_equilibrium$ov16_seroprevalence_finite_seroreversion, type = 'l', xlab = 'time (years)', ylab = 'seroprevalence w/ finite seroreversion', ylim = c(0, 1))
...
plot(tme, output_treat_annual$ov16_seroprevalence_no_seroreversion, type = 'l', xlab = 'time', ylab = 'mean seroprevalence w/o seroreversion')

abline(v = seq(1, 25), col = 'grey', lwd = 0.1)

plot(tme, output_treat_annual$ov16_seroprevalence_finite_seroreversion, type = 'l', xlab = 'time', ylab = 'mean seroprevalence w/ finite seroreversion')

abline(v = seq(1, 25), col = 'grey', lwd = 0.1)

plot(tme, output_treat_annual$percent_never_treated, type = 'l', xlab = 'time', ylab = 'Percent never treated')
...
plot(tme, output_treat_biannual$percent_never_treated, type = 'l', xlab = 'time', ylab = 'Percent never treated')

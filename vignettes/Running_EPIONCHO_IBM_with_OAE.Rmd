...
Below, we present a flow chart detailing the process overview for the the OAE module, highlighting how this module is parameterised and connects to the main transmission model. 

...
output_OAE_treat_annual <- ep.equi.sim(time.its = timesteps,
                                   ABR = ABR.in,
                                   N.in = 400,
                                   treat.timing = NA,
                                   treat.int = trt.int,
...
plot(tme, output_treat_annual$OAE_prev, type = 'l', xlab = 'time', ylab = 'OAE prevalence')
...
plot(tme, output_treat_biannual_OAE$OAE_prev, type = 'l', xlab = 'time', ylab = 'OAE prevalence')

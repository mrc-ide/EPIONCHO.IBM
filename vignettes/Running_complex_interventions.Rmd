...
plot(years, output_treat_variable$ov16_seroprevalence_combined_seroreversion, type = 'l', xlab = 'time (years)', ylab = 'seroprevalence', ylim = c(0, 1))
```
...
plot(years, output_treat_correlation$ov16_seroprevalence_combined_seroreversion, type = 'l', xlab = 'time (years)', ylab = 'seroprevalence', ylim = c(0, 1))
```
...
plot(years, output_treat_drugtype$ov16_seroprevalence_combined_seroreversion, type = 'l', xlab = 'time (years)', ylab = 'seroprevalence', ylim = c(0, 1))
abline(v = seq(1, 20), col = 'grey', lwd = 0.1)
abline(v = seq(21, 25), col = 'grey', lwd = 0.3)
...
plot(years, output_VC$ov16_seroprevalence_combined_seroreversion, type = 'l', xlab = 'time (years)', ylab = 'seroprevalence', ylim = c(0, 1))
abline(v = c(3, 17), col = 'grey', lwd = 0.1) # lines specifying where VC period
mtext("Vector control period", side=3, line=0.5, at=9.5, col="darkgrey") # Rotated y axis label
